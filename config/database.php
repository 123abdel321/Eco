...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'eco' => [
            'driver' => 'mysql',
            'url' => env('ECO_DATABASE_URL'),
            'host' => env('ECO_DB_HOST', '127.0.0.1'),
            'port' => env('ECO_DB_PORT', '3306'),
            'database' => env('ECO_DB_DATABASE', 'forge'),
            'username' => env('ECO_DB_USERNAME', 'forge'),
            'password' => env('ECO_DB_PASSWORD', ''),
            'unix_socket' => env('ECO_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
